  ...
  survey: [
    {
      ...
      answer: [
        ...
        {
          text: '1년 전에 알려줬어도 안 갔을텐데.. 더 빠르게 집으로 간다.',
          result: 'I',
        },
      ],
    },
    {
      ...
      answer: [
        {
          text: '뭔소리야, 그냥 하던 대로 개발하면 되는거지! 기존 생각대로 개발한다',
          result: 'S',
        },
        {
...
// 리액트 앱이 최초 실행 될 때, reducer에 전달할 빈 초기 값 설정
...
// 리듀서 설정하기(MongoDB연결)
// const mbti = (state = initStateEmpty, action) => {
//   switch (action.type) {
//     case CHECK:
//       return {
//         ...state,
